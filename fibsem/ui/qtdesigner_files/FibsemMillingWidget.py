...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        # self.pushButton_run_adaptive_polish = QtWidgets.QPushButton(Form)
        # self.pushButton_run_adaptive_polish.setObjectName("pushButton_run_adaptive_polish")
        # self.gridLayout.addWidget(self.pushButton_run_adaptive_polish, 27, 0, 1, 2)
        ...
        #Form.setTabOrder(self.pushButton_run_adaptive_polish, self.doubleSpinBox_hfw)
    ...
    def retranslateUi(self, Form):
        ...
        #self.pushButton_run_adaptive_polish.setText(_translate("Form", "Run Adaptive Polish"))
